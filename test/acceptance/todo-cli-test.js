    ...
    it('errors if a todo item is no longer valid when running without params', async function () {
      ...
      expect(result.stdout).toMatchInlineSnapshot(`
        "app/templates/require-button-type.hbs
          -:-  error  Todo violation now passes the \`require-button-type\` rule! 🎉 🎉  Please run \`ember-template-lint app/templates/require-button-type.hbs --fix\` to remove this todo from the todo list.  invalid-todo-violation-rule
