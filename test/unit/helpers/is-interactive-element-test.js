...
describe('isInteractiveElement', function() {
  ...
  let interactive = {
    ...
    '<div role="combobox"></div>': 'an element with `role="combobox"`',
    '<div role="grid"></div>': 'an element with `role="grid"`',
    '<div role="listbox"></div>': 'an element with `role="listbox"`',
    '<div role="menu"></div>': 'an element with `role="menu"`',
    '<div role="menubar"></div>': 'an element with `role="menubar"`',
    '<div role="radiogroup"></div>': 'an element with `role="radiogroup"`',
    '<div role="tablist"></div>': 'an element with `role="tablist"`',
    '<div role="tree"></div>': 'an element with `role="tree"`',
    '<div role="treegrid"></div>': 'an element with `role="treegrid"`',
