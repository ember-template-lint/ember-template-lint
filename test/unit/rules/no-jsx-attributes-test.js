          ...
          [
            {
              ...
              "filePath": "layout.hbs",
              "line": 1,
              "message": "Attribute, autoPlay, is probably unintended. In HTML, all attributes are valid, but 'className' doesn't do anything.",
              "rule": "no-jsx-attributes",
              "severity": 2,
              "source": "autoPlay",
            },
          ...
          [
            {
              ...
              "filePath": "layout.hbs",
              "line": 1,
              "message": "Attribute, contentEditable, is probably unintended. In HTML, all attributes are valid, but 'className' doesn't do anything.",
              "rule": "no-jsx-attributes",
              "severity": 2,
