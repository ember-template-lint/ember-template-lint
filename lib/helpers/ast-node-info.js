...
function nodeHasAttributeValue(node, attributeName, nodeAttributeValue) {
  const attributeNode = findAttribute(node, attributeName);
  if (!!attributeNode === false) {
    return false;
  }
  return attributeNodeValue(attributeNode, nodeAttributeValue) === nodeAttributeValue;
}
...
function attributeNodeValue(attrNode) {
  return attrNode.value && attrNode.value.chars;
}
...
module.exports = {
  ...
  nodeHasAttributeValue: nodeHasAttributeValue,
