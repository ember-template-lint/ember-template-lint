...
class Linter {
  ...
  getConfigForFile(options) {
    let fileConfig = Object.assign({}, this._moduleStatusCache.getConfigForFile(options));

    delete fileConfig.loadedConfigurations;
    delete fileConfig._processed;
    delete fileConfig.shouldIgnore;
