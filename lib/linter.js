...
export default class Linter {
  ...
  async _applyFixes(options, results) {
    ...
    let isTemplateTag = isSupportedScriptFileExtension(options.filePath);

    if (isTemplateTag) {
      return this._applyEmbeddedFix(ruleNames, options, fileConfig);
    }

    return this._applyStandaloneFix(ruleNames, options, fileConfig);
  }
