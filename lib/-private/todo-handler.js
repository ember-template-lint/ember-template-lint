...
export default class TodoHandler {
  constructor(workingDir) {
    ...
    this.todoStorageFileExists = false;
  }

  checkStorageFile() {
    this.todoStorageFileExists = todoStorageFileExists(this._workingDir);
    return this.todoStorageFileExists;
  }
