...
module.exports = class InvalidInteractive extends Rule {
  static get meta() {
    return {
      description: 'disallows interactions on non-interactive elements',
      category: 'Best Practices', // 'Stylistic Issues', 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: {},
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/no-invalid-interactive.md',
      fixable: false,
    };
  }
  parseConfig(config) {
