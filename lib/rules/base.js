...
module.exports = class Base {
  ...
  processConfigForSeverity(configData) {
    ...
    if (typeof configData === 'string') {
      severityConfig = _determineConfigForSeverity(configData);
      if (severityConfig) {
        this.severity = severityConfig.severity;
        return severityConfig.config;
      }
      return configData;
    }
    ...
    if (typeof configData === 'object') {
      ...
      if (configData.severity) {
        severityConfig = _determineConfigForSeverity(configData.severity);
        ...
        return configData.config ? configData.config : severityConfig.config;
      }
    }
    return configData;
  }
