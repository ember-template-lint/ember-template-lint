...
function isTemplateOnlyComponent(hbsFilePath, validComponentExtensions) {
  ...
  // TODO: handle components in pods layout
  // for this we must test if the directory has a route/controller first
  // default to false to prevent false-positives in pods
  return false;
}
