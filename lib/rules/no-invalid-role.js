  ...
  parseConfig(config) {
    ...
    let errorMessage = createErrorMessage(
      ...
      [
        ...
        '    * `catchInvalidRoles` -- Whether invalid role values should be allowed (defaults to `false`)',
      ],
      config
    );
  ...
  visitor() {
    return {
      ElementNode(node) {
        ...
        if (this.config.catchInvalidRoles && !VALID_ROLES.includes(roleValue.toLowerCase())) {
          this.log({
