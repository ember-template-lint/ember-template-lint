...
module.exports = class NoInvalidRole extends Rule {
  static get meta() {
    return {
      description: 'disallows `role` of `presentation` or `none` on semantic elements',
      category: 'Best Practices', // 'Stylistic Issues', 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: {},
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/no-invalid-role.md',
      fixable: false,
    };
  }
  visitor() {
