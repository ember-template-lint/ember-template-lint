...
module.exports = function(addonContext) {
  ...
  LogStaticStrings.prototype.visitors = function() {
    ...
    return {
      ...
      TextNode: function(node) {
        ...
        if (!pluginContext.isDisabled()) {
          pluginContext._checkNodeAndLog(node, '', node.loc);
        }
      },

      ElementNode: {
        enter: function(node) {
          pluginContext._currentElementNode = node;
        },

        exit: function() {
          pluginContext._currentElementNode = null;
      ...
      AttrNode: function(node) {
        if (!pluginContext.isDisabled()) {
          pluginContext._getBareStringAttribute(node);
        }
      }
    };
  };

  LogStaticStrings.prototype._getBareStringAttribute = function(attribute) {
    var tag = this._currentElementNode.tag;
