...
module.exports = class ElementAttriutesOrder extends Rule {
  visitor() {
    ...
    function extractElementTokens(node, nodeText) {
      ...
      node.modifiers.forEach(modifier => {
        ...
        keys.push(['modifiers', nodeText.indexOf(source), source, modifier]);
      });
      return keys;
    }
    ...
    function combineElementTokens(tokens) {
      ...
      tokens.forEach(([name, index, source, node]) => {
