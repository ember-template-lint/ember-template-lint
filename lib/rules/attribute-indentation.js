...
module.exports = class AttributeSpacing extends Rule {
  static get meta() {
    return {
      description: 'requires params & attributes to be indented',
      category: 'Stylistic Issues', // 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: {},
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/attribute-indentation.md',
      fixable: false,
    };
  }
