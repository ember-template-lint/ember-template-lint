...
const ARRAY_DEPRECATION_MESSAGE = 'Specifying an array as the configurate for the `no-nested-interactive` rule is deprecated and will be removed in future versions.  Please update `.template-lintrc.js` to use the newer object format.';
