...
module.exports = class NoWhitespaceWithinWord extends Rule {
  static get meta() {
    return {
      description: 'disallows use of excess whitespace within a word for formatting purposes',
      category: 'Best Practices', // 'Stylistic Issues', 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: {},
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/no-whitespace-within-word.md',
      fixable: false,
    };
  }
  visitor() {
