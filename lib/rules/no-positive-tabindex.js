...
module.exports = class NoPositiveTabindex extends Rule {
  static get meta() {
    return {
      description: 'disallows `tabindex` values greater than 0',
      category: 'Possible Error', // 'Stylistic Issues', 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: {},
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/no-positive-tabindex.md',
      fixable: false,
    };
  }
  visitor() {
