...
module.exports = class NoPartial extends Rule {
  static get meta() {
    return {
      description: 'requires quotes for all HTML attribute values',
      category: 'Possible Error', // 'Stylistic Issues', 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: {},
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/no-quoteless-attributes.md',
      fixable: false,
    };
  }
  visitor() {
