...
module.exports = class LogStaticStrings extends Rule {
  static get meta() {
    return {
      description: 'disallows plain strings (helpful for intl apps)',
      category: 'Possible Error', // 'Stylistic Issues', 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: {},
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/no-bare-strings.md',
      fixable: false,
    };
  }
  constructor(options) {
