...
module.exports = class IframeHasTitle extends Rule {
  static get meta() {
    return {
      description: 'requires `<iframe>` elements to have a `title` attribute',
      category: 'Best Practices', // 'Stylistic Issues', 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: {},
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/require-iframe-title.md',
      fixable: false,
    };
  }
