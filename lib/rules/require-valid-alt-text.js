...
export default class RequireValidAltText extends Rule {
  ...
  /**
   * @returns {import('./types.js').VisitorReturnType<RequireValidAltText>}
   */
  visitor() {
    return {
      ElementNode(node) {
        ...
        if (isImg) {
          ...
          // src value is dynamic and alt value is not
          if (srcValue && srcValue.type && altValue && !altValue.type) {
            this.logNode({
