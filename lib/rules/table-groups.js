...
module.exports = class TableGroups extends Rule {
  static get meta() {
    return {
      description: 'requires use of `thead`, `tbody`, and `tfoot` as child elements of `<table>`',
      category: 'Best Practices', // 'Stylistic Issues', 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: {},
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/table-groups.md',
      fixable: false,
    };
  }
  visitor() {
