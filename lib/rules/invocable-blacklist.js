...
module.exports = class InvocableBlacklist extends Rule {
  static get meta() {
    return {
      description: 'disallows certain components or helpers from being used',
      category: 'Best Practices', // 'Stylistic Issues', 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: {},
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/invocable-blacklist.md',
      fixable: false,
    };
  }
  parseConfig(config) {
