...
const ERROR_MESSAGE_DOUBLE_NEGATION = 'Remove double negation';
  ...
  visitor() {
    function checkNode(node) {
      ...
      const doubleNegation =
        node.params[0].params[0].path && node.params[0].params[0].path.original === 'not';
      if (isIf && node.params[0].params[0].type === 'SubExpression' && !doubleNegation) {
