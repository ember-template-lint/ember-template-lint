...
// BASE_BLOCK_ELEMENT is for test purpose only
// If you add a block tag element to the default list, you must add it here
const BASE_BLOCK_ELEMENT = ['span'];
...
module.exports.BASE_BLOCK_ELEMENT = BASE_BLOCK_ELEMENT;
