    ...
    switch (configType) {
      ...
      case 'object':
        if (Array.isArray(config.allow)) {
          ...
          let newRuleSet = [...config.allow, ...ALLOWED_CHILDLESS_TAGS];
        ...
        if (Array.isArray(config.block)) {
          ...
          ALLOWED_CHILDLESS_TAGS = ALLOWED_CHILDLESS_TAGS.filter(
...
module.exports.ALLOWED_CHILDLESS_TAGS = ALLOWED_CHILDLESS_TAGS;
