...
module.exports = class LinkRelNoopener extends Rule {
  static get meta() {
    return {
      description: 'disallows opening a link in a new tab without additional attributes',
      category: 'Best Practices', // 'Stylistic Issues', 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: {},
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/link-rel-noopener.md',
      fixable: false,
    };
  }
  parseConfig(config) {
