...
module.exports = class LengthValidation extends Rule {
  static get meta() {
    return {
      description: 'helps enforce a specified template length',
      category: 'Best Practices', // 'Stylistic Issues', 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: {},
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/template-length.md',
      fixable: false,
    };
  }
  parseConfig(config) {
