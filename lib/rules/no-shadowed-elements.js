...
module.exports = class NoShadowedElements extends Rule {
  static get meta() {
    return {
      description: 'disallows same-name ambiguity caused in some instances of shadowed elements',
      category: 'Possible Error', // 'Stylistic Issues', 'Deprecated Rules', 'Possible Error', 'Best Practices',
      presets: { recommended: true },
      url:
        'https://github.com/ember-template-lint/ember-template-lint/blog/master/docs/rules/no-shadowed-elements.md',
      fixable: false,
    };
  }
  visitor() {
