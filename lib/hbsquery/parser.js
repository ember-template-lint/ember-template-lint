  ...
  let result = {
    ...
    parse(input, startRule) {
      ...
      function parse_identifierName() {
        let cacheKey = `identifierName@${pos}`;
        let cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_sequence() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, subject, as) {
            let b = as.length === 1 ? as[0] : { type: 'compound', selectors: as };
            if (subject) {
              b.subject = true;
            }
            return b;
    ...
    function buildMessage(expected, found) {
      ...
      switch (expected.length) {
        ...
        case 1:
          ...
          break;
        default:
          expectedHumanized = `${expected.slice(0, expected.length - 1).join(', ')} or ${
