const { traverse } = require('ember-template-recast');
let visitorKeys = require('../../node_modules/@glimmer/syntax/dist/commonjs/es5/lib/types/visitor-keys');
